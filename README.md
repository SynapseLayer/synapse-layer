...
**Now available as MCP Skill** → [inference-sh/skills PR #8](https://github.com/inference-sh/skills/pull/8)
...
See [SECURITY.md](SECURITY.md) for full architecture, key management and compliance (GDPR / LGPD ready).
